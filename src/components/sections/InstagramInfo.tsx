...
const InstagramInfo = () => {
  return (
    <div className="md:bg-card">
      <div className="flex flex-col mx-auto px-5 gap-4 items-center py-10 md:flex-row md:gap-5 md:justify-center md:my-[72px] md:max-w-[520px] md:w-full">
        <InstagramForInfo className="w-[80px] h-[80px] md:w-[103px] md:h-[103px]" />
        <p className="bg-card text-black text-base p-4 text-center md:w-[423px] md:px-1 md:text-[22px] md:leading-6 md:tracking-tight">

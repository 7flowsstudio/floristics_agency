...
const Contacts = () => {
  const linkStyles =
    'text-black text-[16px] font-medium underline underline-offset-4 transition-all duration-300 hover:text-[#1C686D] hover:no-underline';

  const socialIconStyles =
    'transition-transform duration-300 hover:scale-110 active:scale-95 inline-block';
  ...
  return (
    <Container className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-center lg:gap-[124px]">
      <motion.div
        ...
        className="flex flex-col gap-4 lg:max-w-[406px] lg:gap-9 lg:justify-center lg:shrink-0"
      >
      ...
      >
        ...
        <div className="mx-[19px] lg:max-w-[584px] flex flex-col">
          <div className="flex flex-col gap-3 bg-card py-8 lg:py-[11px] px-6 rounded-t-lg w-full">
            <div className="flex items-center gap-4 group">
              <PhoneIcon className="group-hover:scale-110 transition-transform duration-300" />
              <a href="tel:+380932451284" className={linkStyles}>
                093 245 1284
              </a>
            </div>

            <div className="flex items-center gap-4 group">
              <MailIcon className="group-hover:scale-110 transition-transform duration-300" />
              <a href="mailto:withtasteart@gmail.com" className={linkStyles}>

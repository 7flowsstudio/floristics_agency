          ...
          <div className="flex flex-col max-w-[344px] md:grid grid-cols-2 grid-rows-2 gap-4 md:max-w-[845px] mx-auto">
            {items.map((item) => (
              <div
                key={item.id}
                className={`
      relative max-w-[412px] rounded-lg overflow-hidden hover:shadow-[0px_0px_7.2px_3px_#9DC6C9BF] active:border-2 active:border-[#1C686D] transition-all duration-300 ease-out
